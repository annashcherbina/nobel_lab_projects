...
computeMatrix reference-point --beforeRegionStartLength 1000 \
	      --regionBodyLength 50 \
	      --referencePoint center \
	      --afterRegionStartLength 1000 \
	      --samplesLabel "Day 0 Aged" "Day 1 Aged" "Day 3 Aged" "Day 5 Aged" "Day 7 Aged" "Day 0 Young" "Day 1 Young" "Day 3 Young" "Day 5 Young" "Day 7 Young" \
	      -p 20 \
	      --binSize 5 \
