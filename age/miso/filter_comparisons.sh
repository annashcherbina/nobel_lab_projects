...
do
    for f in /home/annashch/nobel_lab_projects/age/miso/$analysis/d0.Comparison/d0_Old.bam.out_vs_d0_Y.bam.out/bayes-factors/d0_Old.bam.out_vs_d0_Y.bam.out.miso_bf /home/annashch/nobel_lab_projects/age/miso/$analysis/d5.Comparison/d5_Old.bam.out_vs_d5_Y.bam.out/bayes-factors/d5_Old.bam.out_vs_d5_Y.bam.out.miso_bf /home/annashch/nobel_lab_projects/age/miso/$analysis/d7.Comparison/d7_Old.bam.out_vs_d7_Y.bam.out/bayes-factors/d7_Old.bam.out_vs_d7_Y.bam.out.miso_bf /home/annashch/nobel_lab_projects/age/miso/$analysis/d3.Comparison/d3_Old.bam.out_vs_d3_Y.bam.out/bayes-factors/d3_Old.bam.out_vs_d3_Y.bam.out.miso_bf /home/annashch/nobel_lab_projects/age/miso/$analysis/d1.Comparison/d1_Old.bam.out_vs_d1_Y.bam.out/bayes-factors/d1_Old.bam.out_vs_d1_Y.bam.out.miso_bf
    do
    g=`dirname $f`
    echo $g
