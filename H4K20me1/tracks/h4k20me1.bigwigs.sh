...
bamCoverage -p16 -v --normalizeUsing RPKM --samFlagExclude 780 --binSize 1 --minMappingQuality 30 -b $prefix/merged.Old.bam -o $prefix/counts.rpkm.track.Old.bw 
...
bamCoverage -p16 -v --normalizeUsing RPKM --samFlagExclude 780 --binSize 1 --minMappingQuality 30 -b $prefix/merged.Young.bam -o $prefix/counts.rpkm.track.Young.bw 
