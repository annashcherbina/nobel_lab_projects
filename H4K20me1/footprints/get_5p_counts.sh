...
bamCoverage -p16 -v --normalizeUsing RPKM --binSize 1 --samFlagExclude 780 --Offset 1 2 --minMappingQuality 30 -b $prefix/merged.Old.bam -o $prefix/5p.counts.Old.bw 
...
bamCoverage -p16 -v --normalizeUsing RPKM --binSize 1 --samFlagExclude 780 --Offset 1 2 --minMappingQuality 30 -b $prefix/merged.Young.bam -o $prefix/5p.counts.Young.bw 
