...
data=open("zscores_cluster_specific_diff_genes_reps_averaged_fc.tsv",'r').read().strip().split('\n') 
...
outf=open("filtered.zscores_cluster_specific_diff_genes_reps_averaged_fc.csv",'w')
