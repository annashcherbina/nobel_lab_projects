...
def main():
    ...
    for sample in samples:
        ...
        for index,row in motifs.iterrows():
            motif=row['Motif Name'].split('(')[0].lower()
    ...
    print("adding in denovo motifs")
    for sample in args.denovo:
        samples.append(sample) 
        data=pd.read_csv(sample,header=None,sep=',')
